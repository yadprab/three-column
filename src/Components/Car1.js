...
function Car1() {
  return (
    <>
      <motion.svg width={64} height={40} xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <motion.circle fill="#000" opacity=".201" cx={20} cy={20} initial={{r:0}}  animate={{r:20}} transition={{delay:1}}/>
          <motion.path
